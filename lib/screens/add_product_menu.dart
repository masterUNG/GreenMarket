...
File file;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            showTitleProduct('รูปสินค้าเกษตร'),Mystyle().mySizebox(),
            groupImage(),
            showTitleProduct('รายละเอียดสินค้าเกษตร'),Mystyle().mySizebox(),
            nameForm(),Mystyle().mySizebox(),
            priceForm(),
            Mystyle().mySizebox(),
            detailForm(),
             Mystyle().mySizebox(),
 ...
 Future<Null> chooseImage(ImageSource source) async {
  ...
  Row showTitleProduct(String string) {
    return Row(
      children: <Widget>[
