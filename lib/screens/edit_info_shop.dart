 ...
 Future<Null> editThread() async {
    ...
    await Dio().post(urlUpload, data: formData).then((value) async {
     urlImage = '/GreenMarket1/Shop/$nameFile';
      ...
      String url =
        '${MyConstant().domain}/GreenMarket1/editUserWhereId.php?isAdd=true&id=$id&name1=$name1&storename=$storename&address=$address&phone=$phone&phone=$phone&urlImage=$urlImage';
      Response response = await Dio().get(url);
