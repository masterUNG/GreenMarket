...
class _AddinfoshopState extends State<Addinfoshop> {
  ...
  String storename, name1, address, phone, urlImage;
...
@override
 ...
 SharedPreferences preferences = await SharedPreferences.getInstance();
    ...
    String url = '${MyConstant().domain}/GreenMarket1/editUserWhereId.php?isAdd=true&id=$id&name1=$name1&storename=$storename&address=$address&phone=$phone&phone=$phone&urlImage=$urlImage';
  ...
  Widget nameform() => Row(
        ...
        children: <Widget>[
          Container(
            width: 250.0,
            child: TextField(
              onChanged: (value) => name1 = value.trim(),
